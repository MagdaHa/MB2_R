...
#2. plot ndvi where srtm < Y and landcover = X
...
#5. select LUCAS_LC and srtm where ndvi >= 0.7
...
coordinates(spdf.obj)<- ~x+y #set xy coordinates, column x y is xy coordinates
