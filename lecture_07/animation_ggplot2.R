#----------https://github.com/wegmann/R_scripts/blob/master/eagle_animation.R--------------#
...
#b1 <- read.bitmap("https:\\github.com\\wegmann\\R_scripts\\blob\\master\\eagle_web.png")
b1 <- read.bitmap("C:\\02_Studium\\02_Master\\01_Semester 1\\MB2_Introduction to Programming and Geostatistics_Wegmann\\MB2_R\\lecture_07\\eagle_web.png")
# b2 <- read.bitmap("~/eagle_EO.png")
#b2 <- read.bitmap("https://github.com/wegmann/R_scripts/blob/master/eo.png")
b2 <- read.bitmap("C:\\02_Studium\\02_Master\\01_Semester 1\\MB2_Introduction to Programming and Geostatistics_Wegmann\\MB2_R\\lecture_07\\eo.png")
